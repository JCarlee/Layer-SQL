# Turn all fields into its own row
# Change the write statement
# Add a button to save the file
# Add a save and close button
# Learn how to use file explorer for file loc
...
# fields = 'File Loc and Name', 'Id', 'Name', 'FullName', 'Bubble Title', 'Category', 'Table Name', 'Table Type', \
#        'Data Source', 'Coverage', 'Always Show', 'Update Frequency',

master = Tk()
Label(master, text="File Location and Name").grid(row=0)
...
e1.insert(10,"D:\\uGRIDD\\Layers\\20180202 Rental East Peoria\\02 Layer.sql")
e2.insert(10,"950")
...
# Function to resolve empty input and add quotes if necessary
def try_input(i):
    if i == '':
        return "NULL"
